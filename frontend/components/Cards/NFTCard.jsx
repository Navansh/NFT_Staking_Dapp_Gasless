      ...
      {stake ? (
        <div>
          <section className="text-center max-w-fit border px-3  rounded-md border-[#ffffff82] shadow-lg mx-2 hover:scale-105">
            ...
            <Image src={nft.image ? nft.image : "https://media.raritysniper.com/mutant-ape-yacht-club/4318-600.png?cacheId=2"} unoptimized={true} alt={nft.name} width={200} height={400} />
